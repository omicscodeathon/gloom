...
def run_interactive_visualization():
    ...
    log.info("[6] Dashboard …")
    make_combined_dashboard(fig_v, fig_r, fig_n, fig_i,
    ...
    return {"fig_volcano":fig_v,"fig_ranking":fig_r,"fig_network":fig_n,
            "fig_importance":fig_i,"fig_kegg":fig_kegg}

if __name__ == "__main__":
    r = run_interactive_visualization()
    if r:
        for fname in ["interactive_volcano.html","interactive_ranking.html","interactive_network.html",
                      "interactive_feature_importance.html","interactive_kegg.html","interactive_dashboard.html"]:
