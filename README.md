...
├── network/
│   ├── annotated_coexpression.graphml       # Annotated network for Gephi/Cytoscape
│   ├── annotated_coexpression.cytoscape.xml # Cytoscape-ready XML
│   ├── tumor_coexpression.graphml           # Tumor network export
│   └── normal_coexpression.graphml          # Optional normal-network export
├── reports/
│   ├── pipeline_report.txt                  # Plain-text run report
│   ├── pipeline_summary_table.csv           # Tabular run summary
│   └── pipeline_summary_figure.png          # Figure summary
...
| `full_gene_rankings.csv` | Genome-wide ranking across all scored genes |
...
| `annotated_coexpression.graphml` | Annotated co-expression network for Gephi or Cytoscape |
| `pipeline_report.txt` | Plain-text summary of data provenance, metrics, top genes, and candidates |
